...
// TexDataStringTable info lookup table
...
// GetString finds a string by StringID. StringID comes from TexDataStringData, and
...
// NewTable creates a new table from the contents of the
